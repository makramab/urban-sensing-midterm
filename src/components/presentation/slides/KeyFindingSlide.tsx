  ...
  return (
    <div className="max-w-4xl w-full space-y-8">
      <div className="space-y-3">
        <p className="text-sm font-medium text-primary uppercase tracking-widest">Key Finding</p>
        <h2 className="text-3xl md:text-5xl font-bold text-foreground">No PM2.5 Gradient Detected</h2>
        ...
        {[
          ...
          <div key={z.zone} className={`rounded-xl border-2 ${z.color} bg-muted/30 p-6 space-y-4 text-center`}>
            <div className="flex items-center justify-center gap-2">
              ...
              <p className="text-sm font-medium text-muted-foreground">{z.zone}</p>
            </div>
            <p className="text-4xl md:text-5xl font-black text-foreground">{z.mean}</p>
            <p className="text-sm text-muted-foreground">&mu;g/m&sup3;</p>
